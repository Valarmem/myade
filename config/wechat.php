...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', env('WECHAT_APPID')),         // AppID
    'secret'  => env('WECHAT_SECRET', env('WECHAT_SECRET')),     // AppSecret
    'token'   => env('WECHAT_TOKEN', env('WECHAT_TOKEN')),          // Token
    'aes_key' => env('WECHAT_AES_KEY', env('WECHAT_AES_KEY')),                    // EncodingAESKey
